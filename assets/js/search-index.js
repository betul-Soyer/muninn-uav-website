...
window.SEARCH_INDEX = [
  ...
  { page: "Home", url: "index.html#competition", title: "The SUAS 2026 mission, task by task",
    text: "SUAS competition RoboNation tasks waypoint cruise 3.2 km search detect person tent SLAM mapping orthomosaic payload delivery visual servoing September 14-17 handbook autonomous" },
  ...
  { page: "Team", url: "team.html#structure", title: "Subteams & structure",
    text: "subteams software electrical mechanical yazılım elektrik mekanik organization structure" },
  { page: "Team", url: "team.html#members", title: "Members — SUAS 2026 roster",
    text: "members roster people captain Mustafa Akgün Yusuf Karagülle Beyza Akbaş Betül Soyer Enes Kara Mert Hüseyin Çağlayan Battal Berkay Aktaş software electrical mechanical" },
  { page: "Team", url: "team.html#advisor", title: "Faculty advisor",
    text: "advisor faculty mentor guidance Murat Ceylan Konya Technical University mentors welcome" },
  ...
  { page: "Vehicle", url: "vehicle.html#profile", title: "Dynamic flight profiling — Plan A",
    text: "flight profile Plan A Plan B fixed-wing cruise multicopter mode lawnmower grid search return vertical landing energy efficiency dynamic profiling" },
  ...
  { page: "Vehicle", url: "vehicle.html#autonomy", title: "Autonomy: detection, mapping, delivery",
    text: "autonomy software ROS 2 YOLOv8s custom dataset COCO 45 m detection SLAM orthomosaic mapping visual servoing payload delivery PyQt5 ground control station computer vision AI" },
  ...
  { page: "Vehicle", url: "vehicle.html#design-decisions", title: "Design decisions / trade studies",
    text: "design decisions trade study rationale tail-sitter vs quadplane multirotor unified propulsion plan A plan B custom dataset YOLOv8s PX4 ROS 2 separation digital twin PyQt5 GCS why we chose" },

  /* ---- Build Log ---- */
  { page: "Build Log", url: "journey.html#roadmap", title: "The validation ladder to SUAS 2026",
    text: "roadmap campaign plan milestones validation ladder numerical analysis simulation hardware integration ground testing incremental flight testing June 2026 Maryland timeline" },
  ...
  { page: "Media", url: "media.html#photos", title: "Photo gallery",
    text: "photos pictures gallery images workshop assembly bench Gazebo Baylands digital twin flight line team photo payload" },
  { page: "Media", url: "media.html#videos", title: "Videos",
    text: "videos flight test footage Gazebo mission simulation screencast visual servoing delivery embed" },
